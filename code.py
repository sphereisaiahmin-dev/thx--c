...
def chord_intervals():
    ...
    if not keys[15].pressed and keys[14].pressed and not keys[13].pressed and not keys[12].pressed:
        return (0, 3, 7)
    if not keys[15].pressed and not keys[14].pressed and keys[13].pressed and not keys[12].pressed:
        return (0, 4, 11)
    if not keys[15].pressed and not keys[14].pressed and not keys[13].pressed and keys[12].pressed:
        return (0, 3, 10)
    return (0,)
